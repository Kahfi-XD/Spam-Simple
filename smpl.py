...
def subrek():
	try:
		...
		os.system("xdg-open https://youtube.com/channel/UC6GPl9xMWL61NAXQb3HBrRw")
		time.sleep(5)
		print (f"{biru}Subscribe Channel Author Asli{W} Aing Juga Sluur {biru}^_^...")
...
{biru}╚═╗{W}││││├─┘│  ├┤  {biru}╚═╗{Y}║  {G}║║║ {W}[{Y}•{W}] \033[4;90mXNX Team\033[1;0m
{biru}╚═╝{W}┴┴ ┴┴  ┴─┘└─┘ {biru}╚═╝{Y}╚═╝{G}╚╩╝ {W}[{Y}•{W}] \033[4;90mKahfi aja\033[1;0m
\033[4;97m---------------------------------------------\033[1;0m

{W}[{R}»⟩{W}] Your Ip {R}: \033[4;93m{ip}\033[1;0m
{W}[{R}»⟩{W}] Creator {R}:{W} Kahfi Ganteng
{W}[{R}»⟩{W}] Youtube {R}:{W} KAHFI OFICCIAL
{W}[{R}»⟩{W}] Github  {R}: \033[4;92mhttps://github.com/Kahfi-XD\033[1;0m
...
def wa1():
	try:
		mal=random.choice(["margeng84@gmail.com","ganzpaling@gmail.com","tololbet615@gmail.com","gblkbngt9171@gmail.com","ammarburhanudinafis@gmail.com"])
		...
		for i in range(int(jum)):
			...
			ol2=json.dumps({"name":"AmmarExecuted","email":mal,"password":"@mm4rgans","phone":"+62"+nomor,"phone_format":nomor,"name_toko":"","url_id":"","business_type_id":"","service_type_id":3,"country_id":"ID","city_id":"","state_id":"","pos_resto_mode":0,"i_agree":"true","address":"","id":"null","tokenMiscall":"","use_otp_type":3})
